...
const OnboardingScreen = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Manage how your store will look like on Tàbdey : Upload store banners, manage menu, and more. Make sure it stands out!"
    },
    {
    ...
    <SafeAreaView style={styles.container} edges={['left','right','bottom']}>
      ...
      >
        <View style={styles.content}>
          <Text style={styles.headerTitle}>Reach out to more customers with Tàbdey </Text>
          <Text style={styles.subHeader}>Complete these steps to get your business on Tàbdey </Text>
